...
public class Player implements ModifiableTarget {
	...
	private Map<String, NewFantasyWeeklyStats> newFantasyWeeklyStats;
	
	public Player() {
		newFantasyWeeklyStats = new HashMap<String, NewFantasyWeeklyStats>();
	}
	...
	public Map<String, NewFantasyWeeklyStats> getNewFantasyWeeklyStats() {
		return newFantasyWeeklyStats;
	}

	public void setNewFantasyWeeklyStats(Map<String, NewFantasyWeeklyStats> newFantasyWeeklyStats) {
		this.newFantasyWeeklyStats = newFantasyWeeklyStats;
	}

	@Override
	public String toString() {
		return "Player [id=" + identifier + ", playerName=" + playerName + ", position=" + position + "]";
	}
